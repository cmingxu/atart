...
RSpec.describe "fund_raise_supports/new", type: :view do
  before(:each) do
    assign(:fund_raise_support, FundRaiseSupport.new(
      :fund_raise_id => 1,
      :user_id => 1,
      :amount => 1,
      :message => "MyText",
  ...
  it "renders new fund_raise_support form" do
    render

    assert_select "form[action=?][method=?]", fund_raise_supports_path, "post" do
